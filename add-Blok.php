...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = insertBlokData($blok_name, $tahun, $bulan, $luas_tanah, $jumlah_pohon, $status_id);

    if ($result === true) {
        $_SESSION['message'] = "Blok added successfully!";
        $_SESSION['message_type'] = 'success';
        header("Location: data-Blok.php");
        exit;
    } else {
        $_SESSION['message'] = "Error adding Blok: " . $result;
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal" id="editForm" action="add-Blok.php?" method="post">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label for="blok_name">Blok Name</label>
                                        </div>
                                        <div class="col-md-10 form-group">
                                            <input type="text" id="blok_name" class="form-control" name="blok_name" />
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10 form-group">
                                            <input type="text" id="jumlah_pohon" class="form-control" name="jumlah_pohon" />
                                        </div>
                                        <div class="col-md-2">
                                            <label for="status_id">Keterangan Status</label>
                                        </div>
                                        <div class="col-md-10 form-group">
