...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = insertStatusData($status_name);

    if ($result === true) {
        $_SESSION['message'] = "Status added successfully!";
        $_SESSION['message_type'] = 'success';
    } elseif ($result === "Keterangan Status Sudah Ada") {
        $_SESSION['message'] = $result;  // "Keterangan Status Sudah Ada"
        $_SESSION['message_type'] = 'warning';  // Use 'warning' for this specific case
    } else {
        $_SESSION['message'] = "Failed to add status.";
        $_SESSION['message_type'] = 'error';
    }

    header("Location: data-Status.php"); // Redirect to avoid resubmission
    exit;
}
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal" id="editForm" action="add-Status.php?" method="post">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-2">
