...
<head>
    ...
    <title>List Data Master Blok</title>
                                        ...
                                        <tbody id="dataResults">
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td>
                                                            <a href='edit-Blok.php?blok_id=" . $row['blok_id'] . "' class='btn btn-primary'>Edit</a>
                                                            <a href='delete-Blok.php?blok_id=" . $row['blok_id'] . "' class='btn btn-danger'>Delete</a>
                                                        </td>";
                                                    echo "</tr>";
                                                }
                                            } else {
