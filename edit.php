...
$query = "SELECT td.id, td.rfid, td.blok, td.created_at, s.status_name, td.status_id, td.latitude, td.longitude, td.berat
          FROM tree_data td
...
$statusQuery = "SELECT id, status_name FROM status";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    updateTreeData($id, $rfid, $status_id, $blok, $latitude, $longitude, $berat);
}
                            ...
                            <form class="form form-horizontal" id="editForm" action="edit.php?id=<?php echo htmlspecialchars($data['id']); ?>" method="post">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 form-group">
                                            <fieldset class="form-group">
                                                <select class="form-select" id="status" name="status_id">
                                                    <option value="<?php echo htmlspecialchars($data['status_id']); ?>"><?php echo htmlspecialchars($data['status_name']); ?></option>
                                                    <?php while ($status = $statusResult->fetch_assoc()) : ?>
                                                        <?php if ($status['id'] != $data['status_id']) : ?>
                                        ...
                                        <div class="col-md-10 form-group">
                                            <input type="text" id="blok" class="form-control" name="blok" value="<?php echo htmlspecialchars($data['blok']); ?>" />
                                        </div>
                                        <div class="col-md-2">
                                            <label for="latitude">Latitude</label>
                                        </div>
                                        <div class="col-md-10 form-group">
                                            <input type="text" id="latitude" class="form-control" name="latitude" value="<?php echo htmlspecialchars($data['latitude']); ?>" />
                                        </div>
                                        <div class="col-md-2">
                                            <label for="longitude">Longitude</label>
                                        </div>
                                        <div class="col-md-10 form-group">
                                            <input type="text" id="longitude" class="form-control" name="longitude" value="<?php echo htmlspecialchars($data['longitude']); ?>" />
                                        </div>
                                        <div class="col-md-2">
                                            <label for="berat">Berat</label>
                                        </div>
                                        <div class="col-md-10 form-group">
                                            <input type="text" id="berat" class="form-control" name="berat" value="<?php echo htmlspecialchars($data['berat']); ?>" />
                                        </div>
