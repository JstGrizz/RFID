...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $message = insertOrUpdatePohon($rfid, $ratoon, $latitude, $longitude);
    echo $message;
}
...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3>INPUT DATA POHON</h3>
            </div>
            <div class="page-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <form class="form form-horizontal" id="pohonForm" action="pohon.php" method="post">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10 form-group">
                                            <input type="text" id="ratoon" class="form-control" name="ratoon" placeholder="Input Data Ratoon Ke-berapa" />
                                        </div>
                                        <div class="col-md-2">
                                            <label for="latitude">Latitude</label>
                                        </div>
                                        <div class="col-md-10 form-group">
                                            <input type="text" id="latitude" class="form-control" name="latitude" placeholder="Input Data Latitude" />
                                        </div>
                                        <div class="col-md-2">
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">DATA POHON BERDASARKAN RFID</div>
                        <div class="card-body">
    ...
    <script>
        document.getElementById('pohonForm').addEventListener('keydown', function(event) {
            if (event.key === 'Enter') {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Now the function is defined globally
        });

        function fetchRFIDData() {
            var rfid = document.getElementById('rfid').value;
            var xhr = new XMLHttpRequest();
            xhr.open('GET', 'fetch_data.php?rfid=' + encodeURIComponent(rfid), true);
            xhr.onload = function() {
                if (this.status == 200) {
